...
1. Investigate an existing local route to garden or farm access.
2. Include the rights and interests of current occupants.
3. Compare purchase with sharing or leasing without assuming future price gains.
