...
metadata.update({'lang': 'en-US', 'date': 'v0.8.0 | Food-first revision | September 21, 2026',
...
css = (ROOT / 'scripts/book-print.css').read_text().replace('BOOK_VERSION', 'v0.8.0')
css += '''
...
pdf = OUT / 'Surviving-the-Singularity-v0.8.0.pdf'
