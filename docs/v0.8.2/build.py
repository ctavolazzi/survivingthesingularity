...
metadata.update({'lang': 'en-US', 'date': 'v0.8.2 | What if it all goes right? | September 22, 2026',
...
css = (ROOT / 'scripts/book-print.css').read_text().replace('BOOK_VERSION', 'v0.8.2')
...
pdf = OUT / 'Surviving-the-Singularity-v0.8.2.pdf'
