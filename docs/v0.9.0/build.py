...
metadata.update({'lang': 'en-US', 'date': 'v0.9.0 | What if it all goes right? | September 23, 2026',
...
css = (ROOT / 'scripts/book-print.css').read_text().replace('BOOK_VERSION', 'v0.9.0')
...
pdf = OUT / 'Surviving-the-Singularity-v0.9.0.pdf'
