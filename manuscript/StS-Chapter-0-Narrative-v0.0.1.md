<!--
CHAPTER 0 — Narrative insert for Surviving the Singularity
Version: 0.0.1 (SUPERSEDED — historical scratch copy, do not edit for canon)

>> CANONICAL PROSE:      src/lib/data/book/00-chapter0.md
>> CANONICAL CHARACTER + WORLD RULES: src/lib/data/book/ELIJAH-PROTOCOL.md

This file was the first-draft scratch of Chapter 0 and is kept only for history.
The character baseline here is OUT OF DATE (it describes Elijah as a back-end
developer with a CS grad degree). Per the 2026-07-11 correction, Elijah is a
farm-raised, self-taught, ENTRY-LEVEL data scientist (pivoted in 2020). The
authoritative version lives in the book source above. Do not reconcile prose
into this file — read ELIJAH-PROTOCOL.md instead.
-->
...
*The narrative continues between Parts. The rest of this book is the manual Elijah wished someone had handed him that night at the Bear Flag — what's actually happening, in what order, and what people like us can build while it does.*
