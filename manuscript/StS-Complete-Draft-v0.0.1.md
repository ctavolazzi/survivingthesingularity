...
**Complete Compiled Draft v0.0.1 — 2026-07-01**

*Compiled from the Manuscript Outline, the Master Copy (9 Stages), Draft 4 Pre-Release, Part III: The Practical Transition, the Core Concepts document, the Roadmap & Premortem Pivot chapter, and the Research & Evidence Synthesis. Terminology updated per the Premortem Analysis (Sovereign/Sovereignty → Autonomy/Independence). See Compilation Notes at the end.*
...
*This section is editorial metadata, not book content. Compiled 2026-07-01.*

**Sources merged into this draft (verbatim except where noted):**

1. **Surviving the Singularity — Master Copy** (Google Doc, 2026-06-19) / StS-Page1.pdf — Introduction and the full 9-stage prose (Chapters 2–4, Conclusion).
2. **StS Draft 4 — Surviving the Singularity Pre-Release** (Google Doc, 2026-05-25) — Preface, Chapters 5, 8, 14–17, Appendix A. The older 2024 edition ("A Manual for the Cracks") embedded at the end of that doc was **excluded** as superseded. A duplicated Chapter 6 in the export was de-duplicated.
3. **Surviving the Singularity — Part III: The Practical Transition** (Google Doc, 2026-06-29) — Part III preamble and Chapters 10–13.
4. **Surviving the Singularity Core Concepts** (Google Doc, 2026-06-17) — Chapters 6, 7, 9.
5. **StS-The-Road-Map.pdf** ("Chapter X: The Roadmap and the Premortem Pivot") — Chapter 18.
6. **Singularity Research and Evidence Synthesis** (Google Doc, 2026-06-21) — Chapter 1 and Appendix B. Sections on psychology/backlash were omitted to avoid duplicating Part II.
7. **Singularity STS Back Cover Blurb** (Google Doc, 2026-06-17) — Back cover copy.
8. **Surviving the Singularity: Manuscript Outline** (Google Doc, 2026-06-21) — governs the Part I/II/III structure.

**Terminology audit applied** per *Premortem Analysis: Surviving Singularity* (2026-06-30): all instances of "Sovereign/Sovereignty" replaced with "Autonomy/Independence" variants. Judgment calls: "The Silicon Sovereign" → "The Silicon Machine"; "The Ultimate Sovereign" → "The Ultimate Authority"; "The Sovereign Municipal Code" → "The Municipal Autonomy Code"; "Sovereign Commons and Local Resource Security Act" → "Community Commons and Local Resource Security Act".

**Known gaps / editor's queue:**

- Part II is assembled from the Core Concepts doc and Draft 4's psychology chapter; the outline's "Relational Autonomy" and "Egalitarian Pivot" sections have no dedicated drafted prose yet.
- The outline's "Local Biological Hub" and "Abundance Quotient" concepts are referenced but do not yet have standalone chapters; the ALC chapter (18) carries that weight for now.
- Voice varies between the manifesto register (Intro, Stages, Chapter 18) and the calmer manual register (Draft 4 chapters, Practical Transition) — a unification pass is the next editing step.
- Stage-2 real-world evidence (the June 2026 export-control shutdown / GLM-5.2 events referenced in the Comprehensive Singularity Research Plan) could be woven into Chapter 2.
