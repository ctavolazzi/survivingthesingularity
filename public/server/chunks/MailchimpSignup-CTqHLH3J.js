import { c as create_ssr_component } from './ssr-DH4u9ZHx.js';

const MailchimpSignup = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div id="mc_embed_shell" data-svelte-h="svelte-fd9bf5"><link href="//cdn-images.mailchimp.com/embedcode/classic-061523.css" rel="stylesheet" type="text/css"> <style type="text/css">#mc_embed_signup {
      background: #fff;
      clear: left;
...
export { MailchimpSignup as M };
//# sourceMappingURL=MailchimpSignup-CTqHLH3J.js.map
