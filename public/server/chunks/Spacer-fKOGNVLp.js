import { c as create_ssr_component, v as validate_component, e as escape, f as compute_rest_props, s as setContext, h as spread, j as escape_object, i as escape_attribute_value, d as add_attribute, g as getContext, a as subscribe, k as createEventDispatcher } from './ssr-DH4u9ZHx.js';
import { w as writable } from './index-mAg2Gvoi.js';
...
const BottomNavItem = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  btnClass2 = twMerge(btnClasses[navType], appBtnClasses[appBtnPosition], active && (activeClass ?? context.activeClass), $$props.btnClass);
  ...
  return `${((tag) => {
    return tag ? `<${href ? "a" : "button"}${spread(
      [
        ...
        escape_object($$restProps),
        { class: escape_attribute_value(btnClass2) }
      ],
      {}
        ...
        {},
        {
          default: () => {
            return `${validate_component(NavBrand, "NavBrand").$$render($$result, { href: "/" }, {}, {
              default: () => {
                return `<img src="/src/images/android-chrome-192x192.png" class="me-3 h-6 sm:h-9 svelte-1a8n1m0" alt="Surviving the Singularity Logo"> <span class="self-center whitespace-nowrap text-xl font-semibold" data-svelte-h="svelte-4in9hq">Surviving the Singularity</span>`;
              }
            })} ${validate_component(NavHamburger, "NavHamburger").$$render($$result, {}, {}, {})} ${validate_component(NavUl, "NavUl").$$render($$result, { class: "nav-items-container" }, {}, {
              default: () => {
                return `${validate_component(NavLi, "NavLi").$$render($$result, { href: "/about" }, {}, {
                  default: () => {
                    return `<a class="nav-link svelte-1a8n1m0" href="/about" data-svelte-h="svelte-uk2tpg">About</a>`;
                  }
                })} ${validate_component(NavLi, "NavLi").$$render($$result, { href: "/contact" }, {}, {
                  default: () => {
                    return `<a class="nav-link svelte-1a8n1m0" href="/contact" data-svelte-h="svelte-umfmcm">Contact</a>`;
                  }
                })} ${validate_component(NavLi, "NavLi").$$render($$result, {}, {}, {
                  default: () => {
                    return `<a class="nav-link svelte-1a8n1m0" href="https://docs.google.com/document/d/1plGfd2X8-TsH3aCjbSz6aJeZTpfmrHZ6zNJ2hw6ww9s/edit" target="_blank" data-svelte-h="svelte-1ti7o74">Read a Sample</a>`;
                  }
                })} ${validate_component(NavLi, "NavLi").$$render($$result, { class: "custom-buy-button-container" }, {}, {
                  default: () => {
                    return `<button class="nav-link buy-button svelte-1a8n1m0" data-svelte-h="svelte-1jgivk3">Back the Book</button>`;
                  }
                })}`;
              }
            })}`;
...
const AdjustmentsVerticalOutline = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${withEvents ? `<svg${spread(
    ...
    {}
  )}>${title.id && title.title ? `<title${add_attribute("id", title.id, 0)}>${escape(title.title)}</title>` : ``}${desc.id && desc.desc ? `<desc${add_attribute("id", desc.id, 0)}>${escape(desc.desc)}</desc>` : ``}<path stroke="currentColor" stroke-linecap="round"${add_attribute("stroke-width", strokeWidth, 0)} d="M6 4v10m0 0a2 2 0 1 0 0 4m0-4a2 2 0 1 1 0 4m0 0v2m6-16v2m0 0a2 2 0 1 0 0 4m0-4a2 2 0 1 1 0 4m0 0v10m6-16v10m0 0a2 2 0 1 0 0 4m0-4a2 2 0 1 1 0 4m0 0v2"></path></svg>` : `<svg${spread(
    [
      { xmlns: "http://www.w3.org/2000/svg" },
      { fill: "none" },
      { color: escape_attribute_value(color) },
...
const WalletSolid = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${withEvents ? `<svg${spread(
    ...
    {}
  )}>${title.id && title.title ? `<title${add_attribute("id", title.id, 0)}>${escape(title.title)}</title>` : ``}${desc.id && desc.desc ? `<desc${add_attribute("id", desc.id, 0)}>${escape(desc.desc)}</desc>` : ``}<path fill-rule="evenodd" d="M12 14a3 3 0 0 1 3-3h4a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2h-4a3 3 0 0 1-3-3Zm3-1a1 1 0 1 0 0 2h4v-2h-4Z" clip-rule="evenodd"></path><path fill-rule="evenodd" d="M12.293 3.293a1 1 0 0 1 1.414 0L16.414 6h-2.828l-1.293-1.293a1 1 0 0 1 0-1.414ZM12.414 6 9.707 3.293a1 1 0 0 0-1.414 0L5.586 6h6.828ZM4.586 7l-.056.055A2 2 0 0 0 3 9v10a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2h-4a5 5 0 0 1 0-10h4a2 2 0 0 0-1.53-1.945L17.414 7H4.586Z" clip-rule="evenodd"></path></svg>` : `<svg${spread(
    [
      { xmlns: "http://www.w3.org/2000/svg" },
      { fill: escape_attribute_value(color) },
      escape_object($$restProps),
...
const BottomNav_1 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${validate_component(BottomNav, "BottomNav").$$render(
    ...
    {
      default: () => {
        return `${validate_component(BottomNavItem, "BottomNavItem").$$render($$result, { btnName: "Home", appBtnPosition: "left" }, {}, {
          default: () => {
            return `${validate_component(HomeSolid, "HomeSolid").$$render(
              ...
              {},
              {}
            )} ${validate_component(Tooltip, "Tooltip").$$render($$result, { arrow: false }, {}, {
              default: () => {
                return `Home`;
              }
            })}`;
          ...
          {
            default: () => {
              return `${validate_component(WalletSolid, "WalletSolid").$$render(
                $$result,
                {
                  class: "w-6 h-6 mb-1 text-gray-500 dark:text-gray-400 group-hover:text-primary-600 dark:group-hover:text-primary-500"
                },
        ...
        )} <div class="flex items-center justify-center">${validate_component(BottomNavItem, "BottomNavItem").$$render(
          $$result,
          {
          ...
          {
            default: () => {
              return `${validate_component(PlusOutline, "PlusOutline").$$render($$result, { class: "text-gray-800" }, {}, {})} ${validate_component(Tooltip, "Tooltip").$$render($$result, { arrow: false }, {}, {
                default: () => {
        ...
        )}</div> ${validate_component(BottomNavItem, "BottomNavItem").$$render(
          $$result,
          {
            btnName: "Settings",
            appBtnPosition: "middle"
          ...
          {
            default: () => {
              return `${validate_component(AdjustmentsVerticalOutline, "AdjustmentsVerticalOutline").$$render(
                $$result,
                {
                  class: "w-6 h-6 mb-1 text-gray-500 dark:text-gray-400 group-hover:text-primary-600 dark:group-hover:text-primary-500"
                },
...
const Spacer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div style="${"height: " + escape(height, true) + "; width: " + escape(width, true) + ";"}"></div>`;
});

export { BottomNav_1 as B, Navbar_1 as N, Spacer as S, is_void as i, twMerge as t };
//# sourceMappingURL=Spacer-fKOGNVLp.js.map
