<script>
    // You can add any props or logic here if needed in the future
  </script>
  ...
  <style>
    ...
    /* Dark mode styles */
    :global(.dark) .transformation-pitch {
      background-color: #2c3e50;
      color: #f8f9fa;
    }
  
    :global(.dark) .transformation-pitch h2 {
      color: #f8f9fa;
    }
  
    :global(.dark) .before, :global(.dark) .after {
