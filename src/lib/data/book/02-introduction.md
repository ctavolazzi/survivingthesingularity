...
Not flawlessly. Not without arguments, broken machines, bad decisions, or people who try to keep the best parts for themselves. What if we get capable of doing much more of the work that keeps us alive, and decide that being alive should get less frightening?

Imagine being fired on a Tuesday. There's still an awful conversation to have at home. There are plans to change and bills to sort out. But dinner is already taken care of. Your family can eat tonight, tomorrow, and while you figure out what comes next. Losing the job has changed your life. It hasn't revoked your permission to have one.
...
When someone says, "AI will take my job," listen to what follows. How will I pay the rent? How will I feed my kids? What happens if I get sick? Sometimes those questions get spoken. Sometimes you can hear them in the silence after the first one.
...
But listen to what the fear reveals about the arrangement we live inside. We can get better at producing useful things while people get less able to obtain them. The food can still be growing. The houses can still be standing. The machines can be doing exactly what they were built to do. And a person can lose the income that gives them access to any of it.

There's the contradiction.

When I criticize capitalism in this book, that's what I mean: productive capacity and human security can move in opposite directions. If a machine helps grow the food and the person it displaced can't afford to eat, the failure isn't that we learned to grow food more efficiently. It's that we failed to carry the benefit through to the person.

The leap from "a machine can do my work" to "my family might go hungry" is an indictment of that failure. We've made employment carry responsibilities that matter more than any particular job. We can share those responsibilities differently.
...
Robots can be part of how we keep that promise. So can farmers, cooks, drivers, public services, and the people already doing the unglamorous work of getting food to other people. We don't have to wait for a machine that can do everything before giving useful machines a better assignment.

"Nobody wants to work anymore," as the saying goes. People do want to make things, get good at hard work, run kitchens, take care of each other, and build something that lasts. What I object to is spending forty years renting the opportunity to survive, afraid that getting fired will take the next meal with it.

The line cook can lose his job and still eat. The restaurant can still sell a meal people want to buy. Taste, hospitality, convenience, celebration, and another person's skill don't disappear because hunger stops being compulsory. The terms of work may change, and Chapter 11 takes that seriously. It's not a reason to keep hunger around as a business expense somebody else has to carry.

Food is the first commitment, not the last one. After food comes the rest of the ground: land care, cleaning up what we've dumped, then shelter, then everything further out. Rent, illness, and debt still matter while we work down that list. Starting with dinner gives the larger ambition somewhere solid to stand.

So ask the question this whole book turns on, in plain language. If a robot can fold laundry and walk a dog, why can't it help grow food and build a house? And if it can, why are you still trading your one and only life for the money to rent those things back from whoever owns the machine? This isn't about a better gadget. It's the first real chance to *produce* survival instead of *renting* it: food first, then shelter and care, made close to home, by machines a determined person could learn to build and repair.
...
*The two machines this whole book is about: one that grows the food, one that builds the house. The pieces are arriving. The work is putting them in your neighbors' hands.*

That question isn't a complaint. It's a design brief. The answer isn't to flee the world or bunker against it. It's to build the thing that makes the question obsolete, close to home, with your neighbors, starting now.

## Give the machines a purpose worth having

Grow food. Clean up the land. Help make safe homes. Help researchers and clinicians understand disease. Those are reasons to want more capability, not less.

A machine that prints a wall hasn't provided a home. A model that predicts a protein's structure hasn't cured a patient. The distance between a promising task and a finished benefit is where the work is, and we can be ambitious enough to cross it without pretending it isn't there.
...
Go into any comment section and you'll find the chorus: AI slop this, AI slop that. It's like refusing to eat food grown with agriculture because you're better than a plow, because you *only* forage, because you're a *real* hunter-gatherer. Or refusing anything from the printing press because a *real* reader only reads books scribed by hand. Or refusing anything on a screen because a *real* audience only attends stage plays. There are real objections to these machines, about reliability, privacy, consent, and power, and this book takes them seriously. But strip the aesthetics off the "AI slop" complaint and look at what's usually underneath it: *I was special for knowing how to do this, and now I'm not.* That's a person looking at a tool that could feed someone, teach someone, get a scared kid out of a job that treats a bathroom break as a privilege, and deciding the thing worth posting about is their own wounded status. The wise ones are already past that.
...
That's a future worth doing the work for. The Ledger's first entry closes the Preface, with the panic that greeted one of the most unsettling technologies ever handed to ordinary people: the cheap novel.
