...
*The Sun, via NASA's Solar Dynamics Observatory. Sunlight reaching a planet of living systems and physical limits. (NASA/SDO (AIA), Public domain, via Wikimedia Commons)*
...
1. List the tasks a tool could change in one job.
2. Ask the worker what important work the list missed.
3. Separate time saved from the consequences for income and choice.
