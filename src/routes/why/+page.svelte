		...
		<div class="section-inner">
			...
			<div class="proof-grid" use:stagger={{ delay: 100 }}>
				...
				<div class="proof-card stagger-item">
					...
					<div class="proof-label">YouTube channels worldwide</div>
					<div class="proof-detail">The platform is free to publish on; most channels earn little or nothing</div>
				</div>
			</div>
...
<style>
	...
	.quotes-disclaimer strong { color: #fdf6ec; }
